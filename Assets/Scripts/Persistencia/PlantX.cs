...
public class PlantX : MonoBehaviour
{
    // Variables
    ...
    protected void UpdatePlantSprite()
    {
        ...
        int growthInt = (int)currentGrowth; // (no usado directamente, pero mantenido)
    ...
    // ======== Helpers para guardado/carga ========
    public GrowthState GetGrowth() => currentGrowth;
    public void SetGrowth(GrowthState g)
    {
        currentGrowth = g;
        UpdatePlantSprite();
    }

    public Health GetHealth() => currentHealth;
